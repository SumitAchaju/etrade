...
export default function BreadCrumbs({ title, link }) {
  return (
    <>
      <section className="py-4 mb-5 my-costum-breadcrumb" style={{ background: "#F4F5F8" }}>
        <div className="container d-flex align-items-center justify-content-between my">
          ...
          <div>
            <img src="https://new.axilthemes.com/demo/template/etrade/assets/images/product/product-45.png" alt="iimg" />
          </div>
        </div>
      </section>
    </>
